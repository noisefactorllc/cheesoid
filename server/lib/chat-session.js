      ...
      if (moderator && moderator !== myName) {
        ...
        this.broadcast({
          ...
          text: [
            ...
            `1. Message is for ${myName} (the room host), ambiguously "you", or no one specific — call internal({ trigger: true, target: "${myName}", backchannel: "routing to you" }). The host knows this room best. Output NO text.`,
            `2. Message is for a specific visiting agent (${visitorsList}) — call internal({ trigger: true, target: "<agent name>", backchannel: "routing to you" }). Output NO text.`,
            `3. Message is for the whole group ("everyone", "all") — call internal({ trigger: true, backchannel: "all agents respond" }), then give a brief reply.`,
